...
using BananaLoader.ICSharpCode.SharpZipLib.Encryption;
#endif

using BananaLoader.ICSharpCode.SharpZipLib.Core;
using BananaLoader.ICSharpCode.SharpZipLib.Checksums;
using BananaLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using BananaLoader.ICSharpCode.SharpZipLib.Zip.Compression;

namespace BananaLoader.ICSharpCode.SharpZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="BananaLoader.ICSharpCode.SharpZipLib.Zip.ZipException">
