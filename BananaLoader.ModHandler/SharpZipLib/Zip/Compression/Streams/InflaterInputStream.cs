...
namespace BananaLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	/// as the <see cref="BananaLoader.ICSharpCode.SharpZipLib.GZip.GZipInputStream">GZipInputStream</see>.
	///
