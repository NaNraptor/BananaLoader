...
public:
	...
	static void DebugLog(const char* txt) { if (BananaLoader::DebugMode) Log(txt); }
	static void DebugLog(const char* txt, ConsoleColor color) { if (BananaLoader::DebugMode) Log(txt, color); };
	...
	static void DebugLogWarning(const char* txt) { if (BananaLoader::DebugMode) LogWarning(txt); }
	static void DebugLogWarning(const char* namesection, const char* txt) { if (BananaLoader::DebugMode) LogWarning(namesection, txt); }
	static void DebugLogWarning(std::string txt) { DebugLogWarning(txt.c_str()); }

	static void DebugLogError(const char* txt) { if (BananaLoader::DebugMode) LogError(txt); }
	static void DebugLogError(const char* namesection, const char* txt) { if (BananaLoader::DebugMode) LogError(namesection, txt); }
	static void DebugLogError(std::string txt) { DebugLogError(txt.c_str()); }

	static void LogBananaError(const char* namesection, const char* txt);
	static void LogBananaCompatibility(BananaLoader_Base::BananaCompatibility comp);
