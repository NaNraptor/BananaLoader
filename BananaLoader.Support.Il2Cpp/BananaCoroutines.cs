...
{
    public static class BananaCoroutines
    {
        ...
        private static void ProcessNextOfCoroutine(IEnumerator enumerator)
        {
            ...
            {
                BananaLogger.LogError(e.ToString());
            ...
            switch (next)
            {
                ...
                case Il2CppObjectBase il2CppObjectBase:
                    ...
                    if (nextAsEnumerator != null) // il2cpp IEnumerator also handles CustomYieldInstruction
                        ...
                        BananaLogger.LogWarning($"Unknown coroutine yield object of type {il2CppObjectBase} for coroutine {enumerator}");
                    break;
            }
