...
using BananaLoader.TinyJSON;
using BananaLoader.Tomlyn;
using BananaLoader.Tomlyn.Model;
using BananaLoader.Tomlyn.Syntax;

namespace BananaLoader.AssemblyGenerator
{
    internal static class Main
    {
        ...
        private static void PreSetup(string gameRoot)
        {
            ...
            AssemblyFolder = Path.Combine(gameRoot, "BananaLoader", "Managed");

            MSCORLIB_Path = Path.Combine(AssemblyFolder, "mscorlib.dll");
            
            BaseFolder = SetupDirectory(Path.Combine(Path.Combine(Path.Combine(gameRoot, "BananaLoader"), "Dependencies"), "AssemblyGenerator"));
