...
9. Deprecated BananaModLogger, use BananaLogger instead.
10. Deprecated ModPrefs, use BananaPrefs instead.
11. Added HarmonyInstance Method for easier Unpatching of Mods and Plugins.
12. Create BananaLoaderComponent after first scene load in Mono Games.  (Credits to knah :D)
13. Removed Launch Option --Bananaloader.devpluginsonly.
14. Removed Launch Option --Bananaloader.devmodsonly.
15. Added Launch Option --Bananaloader.loadmodeplugins.
16. Added Launch Option --Bananaloader.loadmodemods.
...
32. Fixed Issue with LogBananaError not running Callbacks.
33. Deprecated BananaLoader.Main use BananaLoaderBase or BananaHandler instead.
34. Revised Base Banana Handling.
35. Revised IniFile.
...
41. Added Launch Option --Bananaloader.consoleontop.  (Credits to trevtv :P)
...
18. Added Installer Check for Manual Zip (BananaLoader.zip) next to the Installer exe.
...
24. Added Console Log Callbacks to BananaLoader.Console.
...
8. UnityCrashHandler now terminates upon running with BananaLoader.
...
12. Moved LightJson under its own Namespace as BananaLoader.LightJson.
...
3. Added Launch Option "--Bananaloader.agfvunhollower" that Forces the Assembly Generator to use a Specified Version of Il2CppAssemblyUnhollower.
4. Added Location property to the BananaMod class.
...
8. Revised BananaMod class to use a new BananaBase.
9. All Commonly used Methods and Properties that both BananaMod and BananaPlugin use have been moved to BananaBase.
...
12. Added better Legacy Version handling for "--Bananaloader.agfvunhollower".
...
20. Forced Installer to reinstall the entire BananaLoader folder.
...
25. Re-enabled Launch Option "--Bananaloader.devpluginsonly".
...
29. Added Launch Option "--Bananaloader.hidewarnings" that will Hide Warnings from Displaying in Normal Console.  (Debug Console ignores this Launch Option.)
...
32. Log Spam Shield will now Disable itself when BananaLoader is using Debug Mode/Console.
33. Log Spam Shield has now been moved to the Native Logger.
34. Added Launch Option "--Bananaloader.maxwarnings" for Setting the Max Amount of Warnings for the Log Spam Shield.  (Debug Console ignores this Launch Option, Default is 100, 0 to Disable.)
35. Added Launch Option "--Bananaloader.maxerrors" for Setting the Max Amount of Errors for the Log Spam Shield.  (Debug Console ignores this Launch Option, Default is 100, 0 to Disable.)
36. Fixed Memory Leak in Log Spam Shield.
37. Fixed Issue with Exports.
38. Moved DLL Status to its own Enum.
39. Added "Compatibility" property to BananaBase.
40. Removed "IsUniversal" property from BananaBase.
...
45. Moved Tomlyn to its own Namespace under BananaLoader.Tomlyn.
...
59. Added BananaOptionalDependencies Attribute.  (Credits to zeobviouslyfakeacc :3)
...
68. Added Launch Option "--Bananaloader.chromium" to turn the Console Color Magenta.  (Thanks Chromium lol)
...
73. Changed Launch Option "--Bananaloader.chromium" to "--Bananaloader.magenta".
...
11. Fixed and Re-Enabled --Bananaloader.hideconsole.
...
23. Small change to version.dll to Prevent Crashing when BananaLoader.dll fails to load.
...
33. Added new Launch Option --Bananaloader.devmodsonly.
...
44. Added Launch Option --Bananaloader.agregenerate.
...
60. Fixed Issue with Zipped Mod Support when using --Bananaloader.devmodsonly.
61. Added Launch Option --Bananaloader.devpluginsonly.
62. Updated Il2CppAssemblyUnhollower Download to v0.4.7.  (Credits to knah :D)
63. Launch Option --Bananaloader.quitfix has been changed to --quitfix.
64. Temporarily Disabled Plugins.
65. Temporarily Disabled Launch Option --Bananaloader.devpluginsonly.
...
70. Fixed Issue with --Bananaloader.devmodsonly.
...
6. Temporarily disabled --Bananaloader.hideconsole.
...
2. Fixed Issue with not having BananaLoader.ModHandler.3.5.dll included in the Release zip.
...
6. Fixed Issue with BananaCoroutines not allowing a yield of Coroutine within a Coroutine.  (Credits to Slaynash :3)
7. Revised README.MD.
8. Changed the Hook and Unhook Internal Calls in BananaLoader.Imports from internal to public to expose them and allow them to be used by Mods.
9. Revised CHANGELOG.MD.
10. Added Built-In QuitFix under the Launch Option --Bananaloader.quitfix  (For Games like VRChat where the Process Hangs after telling it to Exit)
11. Added Stop Methods to BananaCoroutines.  (Credits to Slaynash :3)
12. Fixed Error Handling in BananaCoroutines.  (Credits to Slaynash :3)
13. Fixed Issue with BananaCoroutines when using Non-Yielding Coroutines.  (Credits to Slaynash :3)
14. Added Support for Method Unstripping through Il2CppAssemblyUnhollower to BananaLoader.AssemblyGenerator.
15. Replaced the Doorstop winmm.dll with version.dll.
16. Fixed Compatibility with Il2Cpp Games for 0Harmony in BananaLoader.ModHandler.  (Credits to zeobviouslyfakeacc :D)
17. Fixed Issue with 0Harmony not Unpatching Methods when Unloading.
18. Fixed Incompatibility Issue between 0Harmony in BananaLoader.ModHandler and Mono Game Support.
...
27. Split BananaCoroutines to integrate Support Module support.  (Credits to knah :D)
...
35. Removed Launch Option "--Bananaloader.console".
36. Added Launch Option "--Bananaloader.hideconsole" to Hide the Normal Console.
37. Cleaned up Il2Cpp Imports.
38. Cleaned up Mono Imports.
39. Revised Command Line Parsing.
40. Fixed Issue with the Log Cleaner deleting Logs that were not made by BananaLoader.
41. Added Launch Option --Bananaloader.maxlogs. Sets the Max Logs for the Log Cleaner. Set as 0 to Disable the Log Cleaner.
...
1. Moved Exports in BananaLoader.ModHandler to Mono Internal Calls.
2. Cleaned up Hooking for BananaLoader Internals.
...
5. Added additional check for BananaLoader.ModHandler needing to be built with .NET 3.5.
...
11. Cleaned up BananaLoader.ModHandler to use less Linq when possible for improved performance.  (Credits to Kronik ^.^)
...
16. Made BananaModGameAttribute work as intended and BananaLoader.ModHandler will now only load Mods marked as Compatible or Universal.
17. Temporarily removed the Guid attribute from the AssemblyInfo of both TestMod and BananaLoader.ModHandler.
18. BananaMod now properly caches their respective BananaModInfoAttribute and BananaModGameAttribute.
...
22. Cleaned up and Renamed Exports in BananaLoader.ModHandler.
...
28. Cleaned up the Mod Loading functionality of BananaLoader.ModHandler.
29. Fixed Issue with the Compatibility Check when using multiple BananaModGameAttribute.
...
31. Upgraded BananaLoader.ModHandler and TestMod to .NET v4.7.2.  (As requested by Emilia :D)
32. Made BananaModController use directly invokable delegates for faster invoking.  (Credits to Kronik ^.^)
33. Removed Unneeded Caching of MethodInfo in BananaModController.
34. Added mono-2.0-boehm.dll to Mono Check.
35. Added --Bananaloader.rainbow and --Bananaloader.randomrainbow as Launch Options.  (As requested by Hordini :3)
36. Redesigned the Logging system to be unified between BananaLoader and BananaLoader.ModHandler.
37. Colorized Errors in both Consoles.
38. Added the ability for Mods to set a Color when Logging.
39. Fixed Issue with --Bananaloader.rainbow and --Bananaloader.randomrainbow not working when using --Bananaloader.console.
40. Added Unload Functionality. Entirely unloads BananaLoader.  (BananaLoader::UNLOAD() or BananaLoader.Imports.UNLOAD_BananaLOADER())
...
44. Added BananaCoroutines to handle Coroutine functionality for Mods on both Il2Cpp and Mono.  (Credits to knah :D)
...
48. Added Assertion Manager to handle BananaLoader Internals.
49. Fixed Issue with BananaCoroutines throwing a Cast Exception for knah's UnHollower.
50. Added Support for WaitForFixedUpdate and WaitForEndOfFrame to BananaCoroutines.
51. Fixed Issue with BananaCoroutines throwing a Missing Method Exception for knah's UnHollower.
...
55. Fixed Issue with BananaLoader.ModHandler complaining about Mod Libraries.
56. Fixed Issue with BananaCoroutines processing a yield of null as the same as WaitForFixedUpdate.
57. Made BananaMod use directly invokable virtuals and overrides for faster invoking.  (As requested by knah :3)
58. Removed BananaModController from BananaLoader.ModHandler.
59. Made BananaLoader.ModHandler look for the BananaMod subclass in the Mod's BananaModInfoAttribute instead of searching the entire Assembly.  (As requested by knah :3)
60. Fixed Issue with Logger Imports in BananaLoader.ModHandler being passed garbage strings.
...
4. Logger has been renamed to BananaModLogger to prevent conflict with UnityEngine.Logger.
5. Fixed Crash issue when using System.Type in MUPOT Mode.
6. BananaModInfo Attribute has been changed to an Assembly Attribute.
7. Fixed Issue with BananaModLogger not getting the Mod Name when used outside of the main class.
...
10. Modified BananaLoader.ModHandler to use a Component based system in MUPOT Mode and Mono based games.
...
16. Fixed Issue that caused Unity Crash Handler to initialize BananaLoader twice.
17. Fixed Runtime Initialization issue with Audica that caused crashes.
18. Fixed Execution Order of BananaLoader.ModHandler.
...
28. Added Log in BananaLoader.ModHandler for Unity Version.
29. General Code Cleanup.
30. Fixed OnApplicationQuit not working without MUPOT Mode.
31. Fixed Mono Game Support for games that don't use MonoBleedingEdge.  (BananaLoader.ModHandler and Mods must be compiled with .NET 3.5 Framework)
...
1. Added NET_SDK to be built into BananaLoader.ModHandler as the designated Il2Cpp Wrapper.
...
5. Fixed Issue with Audica crashing when trying to use BananaLoader.
...
11. Added SteamVR and OculusVR Dependency DLLs to BananaLoader/Managed.
...
15. Fixed the bug that caused the Logger from BananaLoader.ModHandler to not properly output when using the Debug Console.
...
BananaLoader [DEBUG] & BananaLoader.ModHandler [RELEASE]  =  Debug Console  
BananaLoader [RELEASE] & BananaLoader.ModHandler [DEBUG]  =  Normal Console  
BananaLoader [DEBUG] & BananaLoader.ModHandler [DEBUG]  =  Debug Console  
BananaLoader [RELEASE] & BananaLoader.ModHandler [RELEASE]  =  Left up to the Launch Options  
